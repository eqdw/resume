...
% Modified: <2009-03-17 20:37:59 CDT>
...
\begin{resume}
  ...
  Fluent with Ruby, Javascript, C++, Java, X/HTML as languages, Git, GDB, Emacs, etc. as tools.\\
...
{\bf Thousand Parsec Project}, USA \& Australia (Telecommuted) \vspace{2mm}\\\vspace{1mm}%
  ...
  Spent my summer working with my mentoring organization, the Thousand Parsec Project, as part of the Google Summer of Code program. Participated in a full small-scale project cycle, developing a new ruleset for the self-named game framework. Development took place exclusively in C++, building a version of the board game Risk. The project was finished far ahead of schedule and I continued on to create an SVG map importer and a short series of screencasts.
