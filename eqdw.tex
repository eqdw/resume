...
\begin{resume}
  ...
  {\bf Programming\\ }
    ...
    Languages  & Ruby, Java, Java/CoffeeScript, Kotlin, Erlang/Elixir, Clojure, C, Go  \\
    Frameworks & Ruby on Rails, React, Android\\
    \end{tabular}
 ...
 \end{list2}
  ...
  \location{}
  \begin{position}
    Back-end Rails engineer with occasional Java work. Implemented
    various new features on the Assessments product. Worked on
    integrating the Assessments product more closely with the
    rest of Indeed's tech stack
  \end{position}
